...
i_databus_cmd_valid[0]= lsu2mem_cmd_valid;
...
lsu2mem_cmd_ready= i_databus_cmd_ready[0];
lsu2mem_rsp_valid= i_databus_rsp_valid[0];
lsu2mem_rsp_rdata= i_databus_rsp_rdata[0];
