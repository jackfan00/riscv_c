...
void lsubussplit()
{
    ...
    lsu_rsp_read  = lsusplit_i_bus_rsp_read;
    ...
    //    lsutransacFIFO_wid =  lsutransacFIFO_wid | ((lsusplit_o_bus_cmd_valid[i] & lsusplit_o_bus_cmd_ready[i]) ? i : 0);
        lsutransacFIFO_wid = lsutransacFIFO_wid | (lsusplit_o_bus_cmd_valid[i] ? i : 0);
    }
    ...
    lsusplit_o_bus_rsp_read[2] = lsu2biu_rsp_read;
    ...
    lsusplit_o_bus_rsp_read[1] = lsu2dtcm_rsp_read;
    ...
    lsusplit_o_bus_rsp_read[0] = lsu2itcm_rsp_read;
    ...
    //
    lsusplit_i_bus_cmd_ready = lsusplit_o_bus_cmd_ready[0]|lsusplit_o_bus_cmd_ready[1]|lsusplit_o_bus_cmd_ready[2];
